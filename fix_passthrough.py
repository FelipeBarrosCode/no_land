...
old_call = """        let mut child = match spawn_gstreamer_pipeline(capture_sample_rate, capture_channels, &endpoint.host, endpoint.rtp_port) {"""
...
old_call_2 = """            match spawn_gstreamer_pipeline(capture_sample_rate, capture_channels, &client_config.remote_host, client_config.rtp_port) {"""
