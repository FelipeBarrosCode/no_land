...
Step 2 of onboarding: The user must go to Vast.ai. Vast.ai is the marketplace that provides the raw server power and cloud GPUs that Noland will rent on the user's behalf for their gaming sessions.