...
Each card represents a machine for rent. It shows download/upload speeds, reliability scores, and VRAM. High internet speeds and reliability are crucial to prevent the game stream from stuttering or dropping.