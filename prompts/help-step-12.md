...
Step 12 of onboarding: Once connected, the user will see a Windows login screen. The default password for the remote streaming desktop is simply 'password'.